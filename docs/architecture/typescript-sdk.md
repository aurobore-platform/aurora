...
- Адаптеры/биндинги: React-хуки, Vue composables, Svelte stores поверх событий/стримов (FR-S5).
- Официальные шаблоны (`create --template react|vue|svelte`) используют эти адаптеры.
