...
[requirements-and-conventions.md](https://github.com/aurobore-platform/aurora/blob/main/docs/aurora/requirements-and-conventions.md).
...
- Имя пакета следует схеме `ru.<organization>.<App>` (в примерах — `ru.auroraos.<App>`),
  см. [adr/ADR-009](https://github.com/aurobore-platform/aurora/blob/main/docs/adr/ADR-009-naming.md).
...
[architecture/configuration.md](../architecture/configuration.md), [adr/ADR-007](https://github.com/aurobore-platform/aurora/blob/main/docs/adr/ADR-007-packaging-build.md).
