...
| [ADR-010](ADR-010-w3c-polyfills.md) | W3C API polyfills — опциональный адаптерный слой | Accepted |
| [ADR-011](ADR-011-camera-frame-channel.md) | Camera frame channel (getUserMedia fallback) | Accepted |
| [ADR-012](ADR-012-ota-live-updates.md) | OTA bundle updates — подписанные live-обновления веб-части | Accepted |
