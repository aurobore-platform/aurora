...
| [Immersive UI / system chrome](immersive-ui.md) | Zero-config insets, opt-out, edge-to-edge |
...
| Написание своего плагина (app-facing) | Alpha |
| Шаблоны React/Vue/Svelte | Alpha |
