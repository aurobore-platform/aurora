...
| **Расширение (SHOULD)** | Camera, Geolocation, Notifications (local), Share, Sensors | Alpha ✅ |
...
## 3. Плагины расширения (Alpha)

Реализованы и доступны в npm; на части сценариев sign-off на физическом устройстве ещё в процессе
(см. заметки в reference и `examples/*-demo`).
...
- [README.md](README.md) — справочник API стандартных плагинов.
- [plugin-api.md](plugin-api.md) — контракт плагина.
- [requirements.md](https://github.com/aurobore-platform/aurora/blob/main/docs/requirements.md) — приоритеты FR-P5/P6/P8.
- [roadmap.md](https://github.com/aurobore-platform/aurora/blob/main/docs/roadmap.md) — когда какой плагин появляется.
